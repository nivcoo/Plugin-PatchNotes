        ...
        <div class="col-md-12">
            <div class="box">
                <div class="box-header with-border">
                    <h3 class="box-title"><?= $Lang->get('PATCHNOTES__GLOBAL_ADD') ?></h3>
                </div>
                <div class="box-body">
                    <form action="<?= $this->Html->url(array('controller' => 'PatchNotes', 'action' => 'add', 'admin' => true, 'plugin' => 'PatchNotes')) ?>"
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input name="lists[add][0]"
                                       class="form-control" type="text">
                                <div class="input-group-append">
                                    <button data-i="0" type="button" id="addList"
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input name="lists[del][0]"
                                       class="form-control" type="text">
                                <div class="input-group-append">
                                    <button data-j="0" type="button" id="delList"
                                            class="btn btn-success"><span class="fa fa-plus"></span></button>
                                </div>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <span class="input-group-prepend"><span
                                            class="input-group-text"><?= $Lang->get('PATCHNOTES__FORM_SHOP_NAME') ?></span></span>
                                <input name="lists[shop][add][0][name]"

                                       class="form-control" type="text">
                                <span class="input-group-prepend"><span
                                            class="input-group-text"><?= $Lang->get('PATCHNOTES__FORM_SHOP_PRICE') ?></span></span>
                                <input name="lists[shop][add][0][price]"

                                       class="form-control" type="text">
                                <span class="input-group-prepend"><span
                                            class="input-group-text"><?= $Lang->get('PATCHNOTES__FORM_SHOP_QUANTITY') ?></span></span>
                                <input name="lists[shop][add][0][quantity]"

                                       class="form-control" type="text">
                                <div class="input-group-append">
                                    <button data-k="0" type="button" id="addShop"
                                            class="btn btn-success"><span class="fa fa-plus"></span></button>
                                </div>
                            </div>
                            ...
                            <div class="input-group">
                                ...
                                <input name="lists[shop][edit][0][name]"
                                       ...
                                       class="form-control" type="text">
                                <span class="input-group-prepend"><span
                                            class="input-group-text"><?= $Lang->get("PATCHNOTES__FORM_SHOP_OLD_PRICE") ?></span></span>
                                <input name="lists[shop][edit][0][old_price]"

                                       class="form-control" type="text">
                                <span class="input-group-prepend"><span
                                            class="input-group-text"><?= $Lang->get('PATCHNOTES__FORM_SHOP_NEW_PRICE') ?></span></span>
                                ...
                                <input name="lists[shop][edit][0][quantity]"
                                       ...
                                       class="form-control" type="text">
                                <div class="input-group-append">
                                    <button data-l="0" type="button" id="editShop"
                                            class="btn btn-success"><span class="fa fa-plus"></span></button>
                                </div>
                            </div>
                            ...
                            <div class="input-group">
                                ...
                                <input name="lists[shop][del][0][name]"
                                       ...
                                       class="form-control" type="text">
                                <div class="input-group-append">
                                    <button data-m="0" type="button" id="delShop"
                                            class="btn btn-success"><span class="fa fa-plus"></span></button>
                                </div>
                            </div>
